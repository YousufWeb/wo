...
ControllerAll = false
local ListSudos ={Sudo_Id,5227817313,1779150039,1689744654}  
...
Status = 'المبرمج يوسف'
elseif tonumber(UserId) == 1689744654  then
Status = 'الزعيم'
elseif tonumber(UserId) == 1689744654  then
Status = 'مطور السورس'
elseif tonumber(UserId) == 1689744654  then
...
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 1689744654 then
